      ...
      <div className={styles.overlay}>
        <section className={styles.hero}>
          <h1 className={styles['hero-title-mobile']}>
            {t.heroTitleStart}{" "}
            <span className={styles['title-highlight']}>{t.heroTitleHighlight}</span>{" "}
        ...
        <section className={styles.overview}>
          <h2 className={styles['overview-title']}>
            {t.overviewTitleStart} <span className={styles['title-highlight']}>{t.overviewTitleHighlight}</span>
          </h2>
